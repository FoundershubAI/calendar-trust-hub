      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-white text-lg font-bold mb-4">CalendarPro</h3>
            <p className="text-sm">
              Professional scheduling software that helps you focus on what matters.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 CalendarPro. All rights reserved.</p>
